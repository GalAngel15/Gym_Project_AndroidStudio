...
public class ExercisesUtiles {
    public static boolean checkValuesForExercise(String selectedMuscle, String exerciseName, int setsString, int repsString, int weightString, int rest) {
    ...
    public static boolean checkValuesForExercise(String selectedMuscle, String exerciseName, String setsString, String repsString, String weightString, String rest) {
        if (selectedMuscle==null ||exerciseName.isEmpty() || setsString.isEmpty() || repsString.isEmpty() || weightString.isEmpty() || rest.isEmpty()) {
            ...
            if(!checkValuesForExercise(selectedMuscle, exerciseName, Integer.parseInt(setsString), Integer.parseInt(repsString), Integer.parseInt(weightString), Integer.parseInt(rest)))
                return false;
        }
        return true;
    }
